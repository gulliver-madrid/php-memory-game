<?php
    ...
    $db = get_db_connection_with_table_partidas();

    function get_db_connection_with_table_partidas(){
        try {
    ...
    function registrar_partida(string $inicio, string $fin, int $num_jugadores): int {
        global $db;  // Usa la conexión de la base de datos que creamos anteriormente
